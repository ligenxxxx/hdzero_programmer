...
def download_thread_proc():
    my_download.download_file("https://api.github.com/repos/hd-zero/hdzero-vtx/releases", "vtx_releases")
    my_download.download_file("https://raw.githubusercontent.com/hd-zero/hdzero-vtx/main/src/common.h", "vtx_common")
    my_download.download_file("https://api.github.com/repos/ligenxxxx/event-vrx/releases", "event_vrx_releases")
    my_download.download_file("https://api.github.com/repos/ligenxxxx/hv/releases", "hybrid_view_releases")
