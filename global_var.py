...
class ch341_status(Enum):
    ...
    HYBRIDVIEWER_CHECK_ALIVE = 11
    HYBRIDVIEWER_CONNECTED = 12
    HYBRIDVIEWER_GET_FW = 13
    HYBRIDVIEWER_UPDATE = 14
    HYBRIDVIEWER_UPDATEDONE = 15
    HYBRIDVIEWER_FW_ERROR = 16
...
class download_status(Enum):
    ...
    DOWNLOAD_HYBRID_VIEWER_FW = 10
    DOWNLOAD_HYBRID_VIEWER_FW_DONE = 11
    DOWNLOAD_HYBRID_VIEWER_FW_FAILED = 12
